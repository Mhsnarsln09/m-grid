...
- Static output exposes pagination mode through root `data-pagination-mode`; offset pagination also exposes `data-page-index`, `data-page-size` and derived `data-page-count`.
...
- Static output pagination mode'u root `data-pagination-mode` uzerinden expose eder; offset pagination ayrica `data-page-index`, `data-page-size` ve derived `data-page-count` expose eder.
