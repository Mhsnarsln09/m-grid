...
describe("@m-grid/dom static rendering", () => {
  it("renders a static grid shell from core state", () => {
    ...
    expect(html).toContain('data-visible-column-count="2"');
  ...
  it("keeps the static HTML output stable", () => {
    ...
    expect(html).toMatchInlineSnapshot(`
      "<div class="m-grid-root" data-density="comfortable" data-theme="light" data-loading-status="idle" data-pagination-mode="none" data-selected-row-count="0" data-visible-column-count="2">
